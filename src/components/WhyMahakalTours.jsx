...
const WhyMahakalTours = () => {
  ...
  useEffect(() => {
    if (isVisible) {
      const targets = { customers: 5000, years: 15, destinations: 50, rating: 4.8 };
      const duration = 2000;
      const steps = 60;
  ...
  const features = [
    {
      ...
      description: "Your safety is our priority. All our vehicles are regularly serviced and drivers are experienced professionals.",
      color: "text-green-500"
    },
    {
      icon: Users,
      title: "Expert Local Guides",
      description: "Our knowledgeable guides bring stories and history to life, ensuring you get the most authentic experience.",
      color: "text-blue-500"
    },
    {
      icon: Clock,
      title: "24/7 Customer Support",
      description: "Round-the-clock assistance to ensure your journey is smooth and worry-free from start to finish.",
      color: "text-purple-500"
    },
    {
      icon: MapPin,
      title: "Customized Itineraries",
      description: "Tailor-made tours designed around your preferences, schedule, and budget for the perfect experience.",
      color: "text-orange-500"
    },
    {
      icon: Award,
      title: "Award-Winning Service",
      description: "Recognized for excellence in tourism with multiple awards and certifications from travel authorities.",
      color: "text-yellow-500"
    },
    {
      icon: Heart,
      title: "Passionate About Travel",
      description: "We don't just organize trips - we create memories that last a lifetime with genuine care and attention.",
      color: "text-red-500"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
            Why <span className="bg-gradient-to-r from-purple-600 to-orange-500 bg-clip-text text-transparent">Mahakal Tours</span>?
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            We're not just a travel company - we're your trusted companions on a spiritual journey, 
            committed to creating unforgettable experiences with genuine care and expertise.
          </p>
        </div>

        {/* Stats Section */}
        <div className={`grid grid-cols-2 md:grid-cols-4 gap-8 mb-20 transition-all duration-1000 delay-200 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {features.map((feature, index) => (
            ...
            >
              <div className={`w-16 h-16 rounded-full bg-gray-50 flex items-center justify-center mb-6 ${feature.color} bg-opacity-10`}>
        ...
        {/* CTA Section */}
        <div className={`bg-gradient-to-r from-purple-600 to-orange-500 rounded-3xl p-8 md:p-12 text-center text-white transition-all duration-1000 delay-700 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}>
          <h3 className="text-3xl md:text-4xl font-bold mb-4">Ready for Your Spiritual Journey?</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              ...
              className="flex items-center space-x-2 bg-white text-purple-600 px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
            ...
            <a
              href="#contact"
              className="flex items-center space-x-2 bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white hover:text-purple-600 transition-all duration-300 transform hover:scale-105"
            >
